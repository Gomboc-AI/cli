...
export class ConfigParser {
    ...
    getPolicies = () => {
        ...
        if (policies == null) {
            throw new Error(`The config file is missing a ${hl('policies')} object`);
        }
        return policies;
    };
    getMustImplementCapabilities = () => {
        const mustImplementCapabilities = this.getPolicies()['must-implement'];
        if (mustImplementCapabilities == null) {
            throw new Error(`The ${hl('policies')} object is missing a ${hl('must-implement')} property`);
        }
        if (mustImplementCapabilities.length == 0) {
            throw new Error(`The ${hl('must-implement')} array must contain at least one Capability`);
        }
    ...
    getOptions = () => {
        ...
        if (options == null) {
            throw new Error(`The config file is missing an ${hl('options')} object`);
        }
        return options;
    };
    getSearchPatterns = () => {
        ...
        if (searchPatterns == null) {
            throw new Error(`The ${hl('options')} object is missing a ${hl('search-pattern')} property`);
        }
        if (searchPatterns.length == 0) {
            throw new Error(`The ${hl('search-pattern')} array must contain at least one pattern`);
        }
